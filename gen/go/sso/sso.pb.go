...
type RegisterResponse struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // User ID of the regitrated user.
}
...
type LoginRequest struct {
	...
	AppId    int32  `protobuf:"varint,3,opt,name=app_id,json=appId,proto3" json:"app_id,omitempty"` // ID of tge app to login to.
}
...
type IsAdminRequest struct {
	...
	UserOd int64 `protobuf:"varint,1,opt,name=user_od,json=userOd,proto3" json:"user_od,omitempty"` // User ID to validate.
}
...
func (x *IsAdminRequest) GetUserOd() int64 {
	if x != nil {
		return x.UserOd
	}
	return 0
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x72, 0x5f, 0x6f, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72,
	0x4f, 0x64, 0x22, 0x2c, 0x0a, 0x0f, 0x49, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x73,
	...
	0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x63, 0x65, 0x42, 0x14,
	0x5a, 0x12, 0x73, 0x61, 0x76, 0x69, 0x6e, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b, 0x73,
